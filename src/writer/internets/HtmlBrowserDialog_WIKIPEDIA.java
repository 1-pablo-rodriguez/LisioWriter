...
public class HtmlBrowserDialog_WIKIPEDIA extends JDialog {
    ...
    public HtmlBrowserDialog_WIKIPEDIA() {
    	
    }

    public HtmlBrowserDialog_WIKIPEDIA(JFrame owner, writer.ui.NormalizingTextPane editorPane, String searchUrl) {
        ...
        SwingWorker<List<String[]>, Void> wk = new SwingWorker<>() {
            ...
            protected void done() {
                try {
                    ...
                    ex.printStackTrace();
                    JOptionPane.showMessageDialog(HtmlBrowserDialog_WIKIPEDIA.this,
...
//	                    }
	        ...
	        protected void done() {
	            if (error != null) {
	                JOptionPane.showMessageDialog(HtmlBrowserDialog_WIKIPEDIA.this, "Erreur lors du chargement : " + error);
	                return;
	            }
	            try {
