...
| **F2**          | Position dans le document  | Dans une fenêtre dédiée, l’application annonce :  
- le **pourcentage de lecture** déjà parcouru ;  
- le **numéro du paragraphe** en cours ;  
- le **titre situé au-dessus** ;  
- ainsi que le **titre suivant**.

Cette fenêtre offre aux personnes non-voyantes un repère rapide pour se situer dans le document et comprendre immédiatement où elles se trouvent dans la structure du texte.
     |
